...
const Login = () => {
    ...
    return (
        <AuthLayout
            title="Welcome Back"
            subtitle="Continue your spiritual journey with TilawaNow."
            quote={{
            ...
            <div className="space-y-6">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between px-1">
                            <Link href="/forgot-password" virtual-link="true" className="text-xs font-medium text-muted-foreground hover:text-primary transition-colors ml-auto">
                                Forgot password?
                            </Link>
                        </div>
                        <div className="relative group">
                ...
                <div className="text-center pt-4">
                    <p className="text-sm text-muted-foreground font-medium">
                        ...
                        <Link href="/signup" className="text-primary hover:underline font-bold transition-all underline-offset-4">
                            Create account
                        </Link>
                    </p>
                </div>
