    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          email: "feedback@tilawanow.app", // Placeholder for feedback
      ...
      <div className="flex-1 container mx-auto px-4 md:px-6 py-12 md:py-20 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 animate-fade-in">
          <button
            ...
            className="group inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-10 transition-all duration-300 px-5 py-2 rounded-full hover:bg-secondary/80 border border-transparent hover:border-border/50"
          >
          ...
          <div className="relative mb-8 group">
            ...
            <div className="relative w-20 h-20 rounded-[2rem] bg-card border border-border/50 flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-500">
              <Mail className="w-10 h-10 text-primary animate-pulse-glow" />
            </div>
          </div>
          ...
          <p className="text-muted-foreground text-lg md:text-xl text-center max-w-lg text-balance opacity-80 leading-relaxed">
        ...
        <div className="max-w-xl mx-auto w-full group/container">
          ...
          <div className={cn(
            "glass-card p-6 md:p-10 relative overflow-hidden transition-all duration-500",
            !submitted && "hover:shadow-primary/5 hover:border-primary/20"
          )}>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in-up">
                <div className="space-y-2 group/field">
                  <label className="text-sm font-medium text-muted-foreground ml-1 group-focus-within/field:text-primary transition-colors">Your Name</label>
                  <Input
                    name="name"
                    value={formData.name}
                    ...
                    required
                    className="h-12 bg-secondary/50 border-border/50 focus:border-primary/50 focus:ring-primary/20 rounded-xl transition-all duration-300"
                  />
                </div>
                
                <div className="space-y-2 group/field delay-100 animate-fade-in-up fill-mode-forwards">
                  <label className="text-sm font-medium text-muted-foreground ml-1 group-focus-within/field:text-primary transition-colors">Email Address</label>
                  <Input
                    name="email"
                    type="email"
                ...
                <div className="space-y-2 group/field delay-200 animate-fade-in-up fill-mode-forwards">
                  <label className="text-sm font-medium text-muted-foreground ml-1 group-focus-within/field:text-primary transition-colors">Subject</label>
                  <Input
                    name="subject"
                ...
                <div className="space-y-2 group/field delay-300 animate-fade-in-up fill-mode-forwards">
                  <label className="text-sm font-medium text-muted-foreground ml-1 group-focus-within/field:text-primary transition-colors">Message</label>
                  <Textarea
                    name="message"
                    ...
                    required
                    rows={6}
                    className="bg-secondary/50 border-border/50 focus:border-primary/50 focus:ring-primary/20 rounded-2xl transition-all duration-300 resize-none p-4"
                  />
                </div>
        ...
        <div className="max-w-4xl mx-auto mt-20 md:mt-32">
            <div className="relative p-8 md:p-12 rounded-[2.5rem] bg-gradient-to-br from-card to-background border border-border/50 text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
                    <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center mb-8 shadow-inner">
                        <Heart className="w-10 h-10 text-primary fill-primary/20" />
                    </div>
                    
                    <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6 tracking-tight">Support our Mission</h2>
                    
                    <p className="text-muted-foreground text-lg mb-10 leading-relaxed max-w-xl">
                        Tadabbur is built and maintained voluntarily to spread the light of the Qur’an. 
      ...
      <Dialog open={isDonateOpen} onOpenChange={setIsDonateOpen}>
        <DialogContent className="sm:max-w-sm bg-card border-border p-8 md:p-12 rounded-[2.5rem] shadow-2xl flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center text-center relative z-10 w-full">
            ...
            <DialogTitle className="text-3xl font-bold mb-3 tracking-tight">Support Tadabbur</DialogTitle>
